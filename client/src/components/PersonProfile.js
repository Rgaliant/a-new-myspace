...
class PersonProfile extends React.Component {
  ...
  render() {
    const { username, address, state, country, gender, bio } = this.state.person
    return (
    <>
    <Container>
      <Row>
        <Col>
          ...
          <br />
            <Image style={{ width: "210px", height: "200px" }} src={ `https://loremflickr.com/400/400/${gender}` } alt="avatar" />
          </div>
          <br />
        ...
        <Table variant="sm">
            ...
            <Table variant="sm">
              ...
              <tbody>
                <tr>
                  <td>
                    <a href="/"><p style={{textAlign: "center"}}>Jeff</p></a>                    
                    <Image src="https://loremflickr.com/120/140/guy" />
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <a href="/"><p style={{textAlign: "center"}}>Tim</p></a>                   
                    <Image src="https://loremflickr.com/120/140/guys" />
                  </td>
                  <td>
                    <a href="/"><p style={{textAlign: "center"}}>Zack</p></a>                    
                    <Image src="https://loremflickr.com/120/140/dudes" />
                  </td>
                  <td>
